...
import { buildSkeleton } from './branching.js';
import { buildLimbs } from './limbmesh.js';
import { buildIsland, buildGrass, radiusAt } from './island.js';
import { makeRenderer, makeScene, fitCamera } from './viewer.js';
...
const skel = buildSkeleton(r, {
  ...
  fineCount: P.fineCount, fineKill: P.fineKill, fineInfluence: P.fineInfluence,
});
